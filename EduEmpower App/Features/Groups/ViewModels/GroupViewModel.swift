...
//        varGroup(title: "Chemistry Group", userids: [dummyUsers[0], dummyUsers[1]]),
//        varGroup(title: "Physics Group", userids: [dummyUsers[2], dummyUsers[3]]),
//        varGroup(title: "History Group", userids: [dummyUsers[3], dummyUsers[4]])
//    ]
//    
